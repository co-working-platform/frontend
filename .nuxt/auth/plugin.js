...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/oauth/token","method":"post","propertyName":"access_token","grant_type":"password","auth":{"username":"my-trusted-client","password":"secret"},"token_required":true,"token_type":"bearer"},"logout":{"url":"/api/auth/logout","method":"post"},"user":{"url":"/user","method":"get","propertyName":false},"logoutRedirectUri":"http://noeworkspace.com"},"grantType":"password","token_required":true,"token_type":"bearer","_name":"local"}))
